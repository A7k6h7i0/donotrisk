            ...
            <Link href={token ? "/" : "/login"} className="group">
              <div className="flex items-center gap-2.5">
                ...
                <div className="relative">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary-600 to-indigo-600 text-white shadow-glow-sm transition-all duration-300 group-hover:shadow-glow-primary group-hover:scale-105">
                ...
                <div className="flex flex-col">
                  <span className="font-display text-xl font-bold tracking-tight text-surface-900">
                    DoNotRisk
                  </span>
                  <AnimatePresence mode="wait">
                    <motion.p
                      ...
                      className="text-[10px] text-surface-400 font-medium tracking-wide"
                    >
                      {quotes[quoteIndex]}
                    </motion.p>
                  </AnimatePresence>
            ...
            {token ? (
              <div className="hidden md:flex items-center gap-2">
                ...
                <div className="relative ml-3">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold text-white shadow-glow-sm hover:shadow-glow-primary transition-all duration-300"
              ...
              <div className="hidden md:flex items-center gap-3">
                ...
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
                  <Link
                    href="/login"
                    className="btn-shimmer inline-flex items-center justify-center rounded-full px-6 py-2.5 text-sm font-semibold text-white shadow-glow-sm hover:shadow-glow-primary transition-all duration-300"
                    style={{ background: "linear-gradient(135deg, #7c3aed, #4f46e5)" }}
                  >
                    Sign In
                  </Link>
